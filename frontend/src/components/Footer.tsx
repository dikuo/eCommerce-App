        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12 md:gap-8">
          ...
          <div className="md:col-span-1 space-y-6">
            ...
            <ul className="space-y-4 text-sm text-zinc-500">
              ...
              <li><Link to="/about" className="hover:text-zinc-900 transition-colors">About us</Link></li>
              <li><Link to="/delivery" className="hover:text-zinc-900 transition-colors">Delivery</Link></li>
